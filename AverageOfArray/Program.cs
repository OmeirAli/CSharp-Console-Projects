...
{       
    public class Program
    {
        ...
        private static void GetAvgFormula(double[] inputNumbers)
        {
            double sum = 0.0;
            ...
            Console.WriteLine("The average of the array elements of {0} is: {1} ", string.Join(", ", inputNumbers), avg);
        }
